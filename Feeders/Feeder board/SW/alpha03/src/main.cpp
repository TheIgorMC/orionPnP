...
/*
  alpha03 - the beta1 codebase. Forked from alpha02 (closed-loop feedback +
  ...
  been validated against real AT24CS02 silicon yet.
  ...
  unchanged from alpha02 - see that project's project.md for the full
  design rationale, and alpha01's for the Modbus feasibility evaluation.

  What alpha03 deliberately does NOT do yet (inherited from alpha01/02):
...
void setup() {
  ...
  Serial1.println(F("alpha03 feeder firmware ready"));
  printStatus();
