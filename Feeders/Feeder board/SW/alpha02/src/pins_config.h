...
/*
  alpha02 pin map (ATmega328PB-AU) - matches the real Feeder board schematic
...
constexpr uint8_t PIN_EXT_LED = 13; // PB5, external LED. Shares the ISP header's SCK line -
                                     // mutually exclusive with ISP flashing at any given instant,
                                     // same tradeoff as Serial1 on D11/D12.
